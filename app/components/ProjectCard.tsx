    ...
    >
      <div className="flex justify-between items-center">
        ...
        <span className="flex items-baseline">
          <h1 className="font-semibold text-lg">{totalBugs} bugs</h1>
      ...
      <div className="flex flex-col gap-4 mt-4">
        <div className="w-full h-4 rounded overflow-hidden bg-primary/40 flex">
          ...
          <div style={{ width: `${fixedPercentage}%` }}></div>
        </div>
                ...
                <h1 className="text-md font-bold flex md:flex-row md:items-center flex-col-reverse md:gap-4 gap-2">
                  ...
                  <span
                    className={`badge badge-sm badge-soft ${
                      lastBug.status == 1 ? "badge-error" : "badge-success"
                    }`}
                  >
                    {lastBug.status == 1 ? (
                    ...
                    {lastBug.status == 1 ? "En attente" : "Corrigé"}
                  </span>
                </h1>
